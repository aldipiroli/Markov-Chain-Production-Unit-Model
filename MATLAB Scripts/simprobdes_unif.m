function [k_step,E,X,T] = simprobdes_unif(model,V,t_reg)
...
count = 0;
for k = 1:L,
    if(T(k) >= t_reg ) %Mi indica che sono arrivato a abbondantemente regime al passo k 
        k_step = k;  
        break 
    else
